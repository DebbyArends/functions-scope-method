...
let cumLaudestudenten = 0

for (let i = 0; i <grades.length; i++) {
    if (grades[i] >= 8) {
        cumLaudestudenten = cumLaudestudenten +1 }
}
console.log(cumLaudestudenten)
...
function cumLaude(arraynumbers) {
    let cumLaudestudentos = 0

    for (let i = 0; i < arraynumbers.length; i++) {
        if (arraynumbers[i] >= 8) {
            cumLaudestudentos = cumLaudestudentos + 1
        }
    }
    return cumLaudestudentos
}
const checkCumLaude1 = cumLaude(grades)
const checkCumLaude2 = cumLaude([6, 4, 5])
const checkCumLaude3 = cumLaude([8, 9, 4, 6, 10])

console.log(checkCumLaude1)
console.log(checkCumLaude2)
console.log(checkCumLaude3)
...
// * Hoe wordt een gemiddelde berekend? alles opgeteld en gedeelt door totaal
// * Wat moet ik verzamelen uit de array van cijfers om uiteindelijk een gemiddelde te kunnen berekenen? cijfers, totaal
...
function highestgrades(arraynumbers) {
    let count = 0
    for (let i = 0; i < arraynumbers.length; i++) {
